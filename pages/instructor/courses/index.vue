<template>
    <div>
        <InstructorHeader :title="'Create Your Course'">
            <template #actionMenu>
                ...
                <div class="column is-8 is-offset-2">
                    ...
                    <div class="tile is-parent is-12">
                        ...
                        <div class="columns">
                            ...
                            <span class="tag"
                                    :class="courseStatusClass(course.status)">{{ course.status }}</span>
                            </div>
...
<script>
import InstructorHeader from '~/components/shared/Header.vue';
export default {
    layout: 'instructor',
    components: {
        InstructorHeader
