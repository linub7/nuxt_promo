...
import TargetStudents from '~/components/instructor/TargetStudents.vue';
import LandingPage from '~/components/instructor/LandingPage.vue';
import Price from '~/components/instructor/Price.vue';
import Status from '~/components/instructor/Status.vue';
import MultiComponentMixin from '~/mixins/MultiComponentMixin.js';
    ...
    methods: {
        ...
        updateCourse() {
            this.$store.dispatch('instructor/course/updateCourse')
                    ...
                    .catch(error => this.$toasted.error('Course can not be updated', { duration: 3000 }));
        },
