            ...
            <div class="box">
                ...
                <div class="field">
                    ...
                    <div v-if="$v.form.username.$error" class="form-error">
                        ...
                        <span v-if="!$v.form.username.minLength" class="help is-danger">Username minimum Length is 6</span>
                    </div>
                    </div>
                </div>
                <div class="field">
                ...
                <button @click.prevent="register" :disabled="$v.form.$invalid" type="button" class="button is-block is-info is-large is-fullwidth">Register</button>
                </form>
            </div>
